...
var _class = function () {
    ...
    (0, _createClass3.default)(_class, [{
        ...
        key: "get",
        value: function get(k, callback) {}
    }, {
        key: "remove",
        value: function remove(k, callback) {}
    }, {
        key: "length",
...
var _Storage2 = __webpack_require__(30);
...
var _class = function (_Storage) {
    (0, _inherits3.default)(_class, _Storage);
    ...
    (0, _createClass3.default)(_class, [{
        key: "add",
        value: function add(k, v) {
            window.localStorage.setItem(k, (0, _stringify2.default)(v));
            return this;
        }
    }, {
        key: "get",
...
var _class = function (_Storage) {
    ...
    (0, _createClass3.default)(_class, [{
        key: "add",
        value: function add(k, v) {
            window.sessionStorage.setItem(k, (0, _stringify2.default)(v));
            return this;
        }
    }, {
        key: "get",
...
var _SessionStorage = __webpack_require__(49);
            ...
            switch (this.driver) {
                case "localStorage":
                    if (this.test('localStorage')) {
                        this.inst = new _LocalStorage2.default();
                        return true;
                    }
                    return true;
                case "sessionStorage":
                    if (this.test('sessionStorage')) {
                        this.inst = new _SessionStorage2.default();
                        return true;
                    }
                    return true;
            };
